...
template <>
struct EnumTraits<IO::FileAccess> : EnumTraitTypes<IO::FileAccess>
{
    static auto EnumName() -> std::string_view { return "FileAccess"; }
    ...
    static constexpr value_type min() { return IO::FileAccess::None; }
    static constexpr value_type max() { return IO::FileAccess::Recorded; }
};
