...
template <>
struct EnumTraits<System::ConsoleColor> : EnumTraitTypes<System::ConsoleColor>
{
    static auto EnumName() -> std::string_view { return "ConsoleColor"; }
    ...
    static constexpr value_type min() { return System::ConsoleColor::Black; }
    static constexpr value_type max() { return System::ConsoleColor::White; }
};
