...
template <>
struct EnumTraits<Diagnostics::SourceLevels> : EnumTraitTypes<Diagnostics::SourceLevels>
{
    static auto EnumName() -> const std::string_view { return "SourceLevels"; }
    ...
    static constexpr value_type min() { return Diagnostics::SourceLevels::All; }
    static constexpr value_type max() { return Diagnostics::SourceLevels::ActivityTracing; }
};
