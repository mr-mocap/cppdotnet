...
template <>
struct EnumTraits<IO::SeekOrigin> : EnumTraitTypes<IO::SeekOrigin>
{
    static auto EnumName() -> std::string_view { return "SeekOrigin"; }
    ...
    static constexpr value_type min() { return IO::SeekOrigin::Begin; }
    static constexpr value_type max() { return IO::SeekOrigin::End; }
};
