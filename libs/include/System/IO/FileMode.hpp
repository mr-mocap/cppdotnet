...
template <>
struct EnumTraits<IO::FileMode> : EnumTraitTypes<IO::FileMode>
{
    static auto EnumName() -> std::string_view { return "FileMode"; }
    ...
    static constexpr value_type min() { return IO::FileMode::CreateNew; }
    static constexpr value_type max() { return IO::FileMode::Append; }
};
