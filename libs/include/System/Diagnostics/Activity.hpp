...
template <>
struct EnumTraits<Diagnostics::ActivityTraceFlags> : EnumTraitTypes<Diagnostics::ActivityTraceFlags>
{
    static auto EnumName() -> std::string_view { return "ActivityTraceFlags"; }
    ...
    static constexpr value_type min() { return Diagnostics::ActivityTraceFlags::None; }
    static constexpr value_type max() { return Diagnostics::ActivityTraceFlags::Recorded; }
};

template <>
struct EnumTraits<Diagnostics::ActivityStatusCode> : EnumTraitTypes<Diagnostics::ActivityStatusCode>
{
    static auto EnumName() -> std::string_view { return "ActivityStatusCode"; }
    ...
    static constexpr value_type min() { return Diagnostics::ActivityStatusCode::Unset; }
    static constexpr value_type max() { return Diagnostics::ActivityStatusCode::Error; }
};

template <>
struct EnumTraits<Diagnostics::ActivityKind> : EnumTraitTypes<Diagnostics::ActivityKind>
{
    static auto EnumName() -> std::string_view { return "ActivityKind"; }
    ...
    static constexpr value_type min() { return Diagnostics::ActivityKind::Internal; }
    static constexpr value_type max() { return Diagnostics::ActivityKind::Consumer; }
};

template <>
struct EnumTraits<Diagnostics::ActivityIdFormat> : EnumTraitTypes<Diagnostics::ActivityIdFormat>
{
    static auto EnumName() -> std::string_view { return "ActivityIdFormat"; }
    ...
    static constexpr value_type min() { return Diagnostics::ActivityIdFormat::Unknown; }
    static constexpr value_type max() { return Diagnostics::ActivityIdFormat::W3C; }
};
