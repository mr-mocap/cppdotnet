...
template <>
struct EnumTraits<System::Base64FormattingOptions> : EnumTraitTypes<System::Base64FormattingOptions>
{
    static auto EnumName() -> std::string_view { return "Base64FormattingOptions"; }

    static constexpr name_value_pair_type NameValueArray[] = {
            { "None",             System::Base64FormattingOptions::None },
            { "InsertLineBreaks", System::Base64FormattingOptions::InsertLineBreaks }
        };
    ...
    static constexpr value_type min() { return System::Base64FormattingOptions::None; }
    static constexpr value_type max() { return System::Base64FormattingOptions::InsertLineBreaks; }
};
