...
class Int32 : public IConvertible,
              public Numerics::INumber<Int32>
{
public:
    ...
    static constexpr Int32 Parse(const std::string_view value_string)
    {
        return Numerics::INumberBase<std::int32_t>::Parse(value_string);
    }

    static constexpr Int32 TryParse(const std::string_view value_string)
    {
