...
template <class T>
struct LegacyRandomAccessIteratorBase
{
    ...
    {
        using difference_type   = LegacyRandomAccessIteratorBase::difference_type;
        using value_type        = LegacyRandomAccessIteratorBase::value_type;
        using pointer           = LegacyRandomAccessIteratorBase::pointer;
    ...
    struct ConstIterator : std::random_access_iterator_tag
    {
        using difference_type   = LegacyRandomAccessIteratorBase::difference_type;
        using value_type        = LegacyRandomAccessIteratorBase::value_type;
        using pointer           = const LegacyRandomAccessIteratorBase::pointer;
    ...
    struct ReverseIterator : std::random_access_iterator_tag
    {
        using difference_type   = LegacyRandomAccessIteratorBase::difference_type;
        using value_type        = LegacyRandomAccessIteratorBase::value_type;
        using pointer           = LegacyRandomAccessIteratorBase::pointer;
    ...
    struct ConstReverseIterator : std::random_access_iterator_tag
    {
        using difference_type   = LegacyRandomAccessIteratorBase::difference_type;
        using value_type        = LegacyRandomAccessIteratorBase::value_type;
        using pointer           = const LegacyRandomAccessIteratorBase::pointer;
    ...
    struct ConstIteratorInterface
    {
        ...
        virtual ConstIteratorInterface &operator -=(difference_type n) = 0;
        virtual difference_type operator -(const ConstIteratorInterface &other) const = 0;

        virtual const_reference operator[](difference_type n) const = 0;

        virtual std::strong_ordering operator <=>(const ConstIteratorInterface &other) const = 0;
    ...
    struct ConstIteratorModel : ConstIteratorInterface
    {
       ...
       ~ConstIteratorModel() override { }
        ...
        std::unique_ptr<ConstIteratorInterface> post_increment() override
        {
            ...
            m_iterator++;
            return std::make_unique<ConstIteratorModel<ListType>>(old);
        }
        ...
        {
            return std::make_unique<ConstIteratorModel<ListType>>( m_iterator + n );
        }
        ...
        difference_type operator -(const ConstIteratorInterface &other) const override
        {
            return m_iterator - dynamic_cast<const ConstIteratorModel<ListType> &>(other).m_iterator; 
        }

        const_reference operator[](difference_type n) const override
        {
            return m_iterator[n];
        }
        ...
        std::strong_ordering operator <=>(const ConstIteratorInterface &other) const override
        {
    ...
    struct IteratorInterface
    {
        ...
        virtual IteratorInterface &operator -=(difference_type n) = 0;
        virtual difference_type operator -(const IteratorInterface &other) const = 0;

        virtual reference operator[](difference_type n) const = 0;

        virtual std::strong_ordering operator <=>(const IteratorInterface &other) const = 0;
    ...
    struct IteratorModel : Interface
    {
       ...
       ~IteratorModel() override { }
        ...
        {
            return std::make_unique<IteratorModel<ListType>>( m_iterator + n );
        }
        ...
        difference_type operator -(const IteratorInterface &other) const override
        {
            return m_iterator - dynamic_cast<const IteratorModel<ListType> &>(other).m_iterator; 
        }
        ...
        std::strong_ordering operator <=>(const IteratorInterface &other) const override
        {
    ...
    struct ConstReverseIteratorInterface
    {
        ...
        virtual std::unique_ptr<ConstReverseIteratorInterface> create_positive_offset(difference_type n) = 0;
        virtual std::unique_ptr<ConstReverseIteratorInterface> create_negative_offset(difference_type n) = 0;
        virtual ConstReverseIteratorInterface &operator +=(difference_type n) = 0;
        virtual ConstReverseIteratorInterface &operator -=(difference_type n) = 0;
        virtual difference_type operator -(const ConstReverseIteratorInterface &other) const = 0;

        virtual const_reference operator[](difference_type n) const = 0;

        virtual std::strong_ordering operator <=>(const ConstReverseIteratorInterface &other) const = 0;
    ...
    struct ConstReverseIteratorModel : ConstReverseIteratorInterface
    {
       ...
       ~ConstReverseIteratorModel() override { }
        ...
        std::unique_ptr<ConstReverseIteratorInterface> create_positive_offset(difference_type n) override
        {
            return std::make_unique<ConstReverseIteratorModel<ListType>>( m_iterator + n );
        }

        std::unique_ptr<ConstReverseIteratorInterface> create_negative_offset(difference_type n) override
        {
            return std::make_unique<ConstReverseIteratorModel<ListType>>( m_iterator - n );
        }

        ConstReverseIteratorInterface &operator +=(difference_type n) override
        {
            m_iterator += n;
            return *this;
        }
        ...
        difference_type operator -(const ConstReverseIteratorInterface &other) const override
        {
            return m_iterator - dynamic_cast<const ConstReverseIteratorModel<ListType> &>(other).m_iterator; 
        }
        ...
        std::strong_ordering operator <=>(const ConstReverseIteratorInterface &other) const override
        {
    ...
    struct ReverseIteratorInterface
    {
        ...
        virtual std::unique_ptr<ReverseIteratorInterface> create_positive_offset(difference_type n) = 0;
        virtual std::unique_ptr<ReverseIteratorInterface> create_negative_offset(difference_type n) = 0;
        virtual ReverseIteratorInterface &operator +=(difference_type n) = 0;
        virtual ReverseIteratorInterface &operator -=(difference_type n) = 0;
        virtual difference_type operator -(const ReverseIteratorInterface &other) const = 0;

        virtual reference operator[](difference_type n) const = 0;

        virtual std::strong_ordering operator <=>(const ReverseIteratorInterface &other) const = 0;

        virtual std::unique_ptr<ReverseIteratorInterface> Clone() const = 0;
    ...
    struct ReverseIteratorModel : ReverseIteratorInterface
    {
       ...
       ~ReverseIteratorModel() override { }
        ...
        ReverseIteratorModel &operator++() override
        {
            ++m_iterator;
            return *this;
        }

        std::unique_ptr<ReverseIteratorModel> post_increment() override
        {
        ...
        std::unique_ptr<ReverseIteratorModel> post_decrement() override
        {
            typename ListType::reverse_iterator old = m_iterator;
        ...
        std::unique_ptr<ReverseIteratorModel> create_positive_offset(difference_type n) override
        {
            return std::make_unique<ReverseIteratorModel<ListType>>( m_iterator + n );
        }

        std::unique_ptr<ReverseIteratorModel> create_negative_offset(difference_type n) override
        {
            return std::make_unique<ReverseIteratorModel<ListType>>( m_iterator - n );
        }

        ReverseIteratorModel &operator +=(difference_type n) override
        {
            m_iterator += n;
            return *this;
        }
        ...
        difference_type operator -(const ReverseIteratorInterface &other) const override
        {
            return m_iterator - dynamic_cast<const ReverseIteratorModel<ListType> &>(other).m_iterator; 
        }
        ...
        std::unique_ptr<ReverseIteratorModel> Clone() override
        {
        ...
        std::strong_ordering operator <=>(const ReverseIteratorModel &other) const override
        {
