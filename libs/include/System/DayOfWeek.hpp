...
template <>
struct EnumTraits<System::DayOfWeek> : EnumTraitTypes<System::DayOfWeek>
{
    static auto EnumName() -> std::string_view { return "DayOfWeek"; }
    ...
    static constexpr value_type min() { return System::DayOfWeek::Sunday; }
    static constexpr value_type max() { return System::DayOfWeek::Saturday; }
};
