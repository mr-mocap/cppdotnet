...
template <>
struct EnumTraits<System::DateTimeKind> : EnumTraitTypes<System::DateTimeKind>
{
    static auto EnumName() -> std::string_view { return "DateTimeKind"; }
    ...
    static constexpr value_type min() { return System::DateTimeKind::Unspecified; }
    static constexpr value_type max() { return System::DateTimeKind::Local; }
};
